...
# Create comprehensive test data matching EXACT warehouse layout
# Warehouse: 2 aisles × 1 rack × 25 positions × 3 levels = 150 storage positions
# Special Areas: RECV-01, RECV-02, STAGE-01, DOCK-01, AISLE-01, AISLE-02
...
# Normal baseline pallets distributed across warehouse (35 pallets - ~10% capacity utilization)
normal_pallets = [
    # Main storage area pallets
    ['PLT-NORMAL-001', '01-01-001A', now - timedelta(hours=2), 'RCT-NORMAL-001', 'Standard Product A'],
    ['PLT-NORMAL-002', '01-01-002A', now - timedelta(hours=2, minutes=5), 'RCT-NORMAL-002', 'Standard Product B'],
    ['PLT-NORMAL-003', '01-01-003A', now - timedelta(hours=2, minutes=10), 'RCT-NORMAL-003', 'Standard Product C'],
    ['PLT-NORMAL-004', '01-01-005A', now - timedelta(hours=2, minutes=15), 'RCT-NORMAL-004', 'Standard Product D'],
    ['PLT-NORMAL-005', '01-01-007A', now - timedelta(hours=2, minutes=20), 'RCT-NORMAL-005', 'Standard Product E'],
    ['PLT-NORMAL-006', '01-01-010B', now - timedelta(hours=2, minutes=25), 'RCT-NORMAL-006', 'Standard Product F'],
    ['PLT-NORMAL-007', '01-01-012A', now - timedelta(hours=2, minutes=30), 'RCT-NORMAL-007', 'Standard Product G'],
    ['PLT-NORMAL-008', '01-01-015C', now - timedelta(hours=2, minutes=35), 'RCT-NORMAL-008', 'Standard Product H'],
    ['PLT-NORMAL-009', '01-01-018A', now - timedelta(hours=2, minutes=40), 'RCT-NORMAL-009', 'Standard Product I'],
    ['PLT-NORMAL-010', '01-01-020B', now - timedelta(hours=2, minutes=45), 'RCT-NORMAL-010', 'Standard Product J'],
    ['PLT-NORMAL-011', '01-01-023A', now - timedelta(hours=2, minutes=50), 'RCT-NORMAL-011', 'Standard Product K'],
    ['PLT-NORMAL-012', '01-01-025C', now - timedelta(hours=2, minutes=55), 'RCT-NORMAL-012', 'Standard Product L'],
    ['PLT-NORMAL-013', '02-01-002A', now - timedelta(hours=3), 'RCT-NORMAL-013', 'Standard Product M'],
    ['PLT-NORMAL-014', '02-01-004B', now - timedelta(hours=3, minutes=5), 'RCT-NORMAL-014', 'Standard Product N'],
    ['PLT-NORMAL-015', '02-01-006A', now - timedelta(hours=3, minutes=10), 'RCT-NORMAL-015', 'Standard Product O'],
    ['PLT-NORMAL-016', '02-01-008C', now - timedelta(hours=3, minutes=15), 'RCT-NORMAL-016', 'Standard Product P'],
    ['PLT-NORMAL-017', '02-01-012A', now - timedelta(hours=3, minutes=20), 'RCT-NORMAL-017', 'Standard Product Q'],
    ['PLT-NORMAL-018', '02-01-015B', now - timedelta(hours=3, minutes=25), 'RCT-NORMAL-018', 'Standard Product R'],
    ['PLT-NORMAL-019', '02-01-018A', now - timedelta(hours=3, minutes=30), 'RCT-NORMAL-019', 'Standard Product S'],
    ['PLT-NORMAL-020', '02-01-022C', now - timedelta(hours=3, minutes=35), 'RCT-NORMAL-020', 'Standard Product T'],
    ['PLT-NORMAL-021', '02-01-025A', now - timedelta(hours=3, minutes=40), 'RCT-NORMAL-021', 'Standard Product U'],
    
    # Special area pallets (normal operations)
    ['PLT-NORMAL-022', 'STAGE-01', now - timedelta(minutes=30), 'RCT-NORMAL-022', 'Staging Product A'],
    ['PLT-NORMAL-023', 'STAGE-01', now - timedelta(minutes=35), 'RCT-NORMAL-023', 'Staging Product B'],
    ['PLT-NORMAL-024', 'DOCK-01', now - timedelta(minutes=40), 'RCT-NORMAL-024', 'Loading Product A'],
    ...
    ['PLT-NORMAL-027', 'RECV-01', now - timedelta(hours=2), 'RCT-NORMAL-027', 'Recent Arrival C'],
    ['PLT-NORMAL-028', 'AISLE-01', now - timedelta(minutes=20), 'RCT-NORMAL-028', 'Transit Product A'],
    ['PLT-NORMAL-029', 'AISLE-02', now - timedelta(minutes=25), 'RCT-NORMAL-029', 'Transit Product B'],
    
    # Additional storage pallets
    ['PLT-NORMAL-030', '01-01-009A', now - timedelta(hours=4), 'RCT-NORMAL-030', 'Standard Product V'],
    ['PLT-NORMAL-031', '01-01-014B', now - timedelta(hours=4, minutes=10), 'RCT-NORMAL-031', 'Standard Product W'],
    ['PLT-NORMAL-032', '02-01-010A', now - timedelta(hours=4, minutes=20), 'RCT-NORMAL-032', 'Standard Product X'],
    ['PLT-NORMAL-033', '02-01-020B', now - timedelta(hours=4, minutes=30), 'RCT-NORMAL-033', 'Standard Product Y'],
    ['PLT-NORMAL-034', '01-01-022A', now - timedelta(hours=5), 'RCT-NORMAL-034', 'Standard Product Z'],
    ['PLT-NORMAL-035', '02-01-024A', now - timedelta(hours=5, minutes=10), 'RCT-NORMAL-035', 'Standard Product AA'],
]
...
lot_pallets = [
    ...
    ['PLT-LOT-001-05', '02-01-003A', now - timedelta(hours=8), 'LOT-001', 'Coordinated Lot Product 5'],
    ['PLT-LOT-001-06', '02-01-003B', now - timedelta(hours=8), 'LOT-001', 'Coordinated Lot Product 6'],
    ['PLT-LOT-001-07', '02-01-005A', now - timedelta(hours=8), 'LOT-001', 'Coordinated Lot Product 7'],
    ['PLT-LOT-001-08', '02-01-005B', now - timedelta(hours=8), 'LOT-001', 'Coordinated Lot Product 8'],
    ['PLT-LOT-001-09', '01-01-008A', now - timedelta(hours=8), 'LOT-001', 'Coordinated Lot Product 9'],
...
# Using your actual AISLE-01 and AISLE-02 locations
aisle_stuck_pallets = [
    ['PLT-AISLE-STUCK-01', 'AISLE-01', now - timedelta(hours=6), 'RCT-AISLE-01', 'Aisle Stuck Product 1'],
    ['PLT-AISLE-STUCK-02', 'AISLE-01', now - timedelta(hours=8), 'RCT-AISLE-02', 'Aisle Stuck Product 2'],
    ['PLT-AISLE-STUCK-03', 'AISLE-02', now - timedelta(hours=7), 'RCT-AISLE-03', 'Aisle Stuck Product 3'],
    ['PLT-AISLE-STUCK-04', 'AISLE-02', now - timedelta(hours=9), 'RCT-AISLE-04', 'Aisle Stuck Product 4'],
]
...
duplicate_pallets = [
    ['DUP-001', '01-01-019A', now - timedelta(hours=5), 'RCT-DUP-001', 'Duplicate Pallet Test 1'],
    ['DUP-001', '02-01-019B', now - timedelta(hours=5, minutes=5), 'RCT-DUP-001-COPY', 'Duplicate Pallet Test 1 Copy'],
    ['DUP-002', '01-01-021A', now - timedelta(hours=5, minutes=10), 'RCT-DUP-002', 'Duplicate Pallet Test 2'],
    ['DUP-002', '02-01-021B', now - timedelta(hours=5, minutes=15), 'RCT-DUP-002-COPY', 'Duplicate Pallet Test 2 Copy'],
]
...
print(f'Normal operations: 35 pallets')
print(f'Date range: {df["Created Date"].min()} to {df["Created Date"].max()}')
print(f'Warehouse capacity utilization: {len(df)}/347 = {len(df)/347*100:.1f}%')
print('\nWarehouse Layout Validation:')
print('Special Areas:')
print('- RECV-01: 10 pallets capacity (RECEIVING zone)')
print('- RECV-02: 10 pallets capacity (RECEIVING zone)')
print('- STAGE-01: 5 pallets capacity (STAGING zone)')
print('- DOCK-01: 2 pallets capacity (DOCK zone)')
print('- AISLE-01: 10 pallets capacity (TRANSITIONAL zone)')
print('- AISLE-02: 10 pallets capacity (TRANSITIONAL zone)')
print(f'Storage Positions: {len(storage_locations)} positions (300 pallet capacity)')
print('\nAnomaly Summary:')
...
print('\nStorage location format: AA-R-PPPX')
print('- AA: Aisle (01-02)')
print('- R: Rack (1)')
print('- PPP: Position (001-025)')
print('- X: Level (A, B, C)')
print('Example: 01-01-001A = Aisle 1, Rack 1, Position 1, Level A')