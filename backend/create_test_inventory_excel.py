...
def create_test_inventory():
    ...
    # These should trigger (>10 hours old) - using real receiving locations
    test_data.extend([
    ...
    # Rule 1 - Should NOT trigger (wrong location type) - using real storage locations
    test_data.extend([
    ...
    # RCV-001 overcapacity (capacity 1) - multiple pallets in same location
    ...
    # Storage location overcapacity (capacity 1) - multiple pallets in same location
    test_data.extend([
    ...
    # Should trigger (>4 hours) - using fake AISLE locations for testing
    ...
    # Additional normal pallets for realistic dataset - using real storage locations
    ...
    # Staging area pallets - using real staging locations
    ...
    # Dock area pallets - using real dock locations
